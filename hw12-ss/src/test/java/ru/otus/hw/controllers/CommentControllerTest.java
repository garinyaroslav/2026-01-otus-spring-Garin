...
class CommentControllerTest {
    ...
    @Test
    @DisplayName("POST /api/comments — без аутентификации возвращает 401")
    void addComment_shouldReturn401WhenNotAuthenticated() throws Exception {
    ...
    @Test
    @DisplayName("DELETE /api/comments/{id} — без аутентификации возвращает 401")
    void deleteComment_shouldReturn401WhenNotAuthenticated() throws Exception {
    ...
    @Test
    @WithMockUser
    @DisplayName("POST /api/comments — создаёт комментарий")
    ...
    @Test
    @WithMockUser
    @DisplayName("DELETE /api/comments/{id} — удаляет комментарий")
