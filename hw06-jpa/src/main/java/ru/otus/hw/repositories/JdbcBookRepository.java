...
public class JdbcBookRepository implements BookRepository {
    ...
    private static class BookRowMapper implements RowMapper<Book> {
        ...
        public Book mapRow(ResultSet rs, int rowNum) throws SQLException {
            Author author = new Author(rs.getLong("author_id"), rs.getString("author_full_name"), List.of());

            return new Book(rs.getLong("id"), rs.getString("title"), author, List.of(), List.of());
        }
    }
        ...
        public Book extractData(ResultSet rs) throws SQLException, DataAccessException {
            ...
            while (rs.next()) {
                if (ent == null) {
                    ...
                    ent.setAuthor(new Author(rs.getLong("author_id"), rs.getString("author_full_name"), List.of()));
                }
