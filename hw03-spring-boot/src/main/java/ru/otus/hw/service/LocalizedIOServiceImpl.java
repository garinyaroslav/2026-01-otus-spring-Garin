...
public class LocalizedIOServiceImpl implements LocalizedIOService {
    ...
    @Override
    public int readIntForRangeLocalized(int min, int max, String messageCode, Object... args) {
        String message = localizedMessagesService.getMessage(messageCode, args);
        return ioService.readIntForRange(min, max, message);
    }
