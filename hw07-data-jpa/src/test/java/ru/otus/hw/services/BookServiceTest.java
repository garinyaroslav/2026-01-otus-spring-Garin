...
class BookServiceTest {
    ...
    void shouldReturnCorrectBookById(Book expectedBook) {
        ...
        assertThat(result)
                ...
                .ignoringFields("id", "genres", "author.fullName", "author.books")
    ...
    void update_shouldUpdateAndReturnBook() {
        ...
        Book expected = new Book(toUpdate.getId(), "Updated Title",
                dbAuthors.get(1), List.of(dbGenres.get(1), dbGenres.get(2)));
    ...
    private static List<Book> getDbBooks(List<Author> authors, List<Genre> genres) {
        return List.of(
                new Book(0L, "Book A", authors.get(0), List.of(genres.get(0))),
                new Book(0L, "Book B", authors.get(1), List.of(genres.get(1))),
                new Book(0L, "Book C", authors.get(0), List.of(genres.get(2))));
    }
